#ifndef AssembleDomain_decl_hpp
#define AssembleDomain_decl_hpp
...
class AssembleDomain : public NonLinearProblem<SC,LO,GO,NO>  {
...
private:
    ...
    mutable BlockMultiVectorPtr_Type sol_rep_;
    string problemType_;
    int problemSize_;
    double lambda_;
    bool loadStepping_;
