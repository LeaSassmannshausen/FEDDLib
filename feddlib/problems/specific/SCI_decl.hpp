...
/*!
    Structure-Chemical/pharmaco mechanical interaction problem

    The problem can be defined monoltihically where the 2 x 2 system stems from the interface
    Or as system with to independet blocks and an, thus, explicit coupling
