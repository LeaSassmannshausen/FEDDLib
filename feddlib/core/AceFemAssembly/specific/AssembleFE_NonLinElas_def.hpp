...
The class calls on the NeoHookQuadraticTets2.f code in the AceInterface folder, which is a Fortran code generated by AceGen. 
The function skr2 computes the element stiffness matrix and residual vector for the non-linear elasticity problem. 
